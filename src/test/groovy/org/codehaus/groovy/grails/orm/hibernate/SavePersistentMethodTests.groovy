...
class SavePersistentMethodTests extends AbstractGrailsHibernateTests {
    ...
    void testFailOnErrorTrueWithValidationErrors() {
        ...
        assert team.errors.getFieldError('homePage').codes.contains('typeMismatch.org.grails.orm.hibernate.SavePersistentMethodTeam.homePage')
        assert team.errors.getFieldError('name').codes.contains('org.grails.orm.hibernate.SavePersistentMethodTeam.name.nullable.error.org.grails.orm.hibernate.SavePersistentMethodTeam.name')
    }
    ...
    void testFailOnErrorConfigTrueWithValidationErrors() {
        ...
        assert msg.contains('Validation Error(s) occurred during save():')
        assert team.errors.getFieldError('homePage').codes.contains('org.grails.orm.hibernate.SavePersistentMethodTeam.homePage.typeMismatch.error')
        assert team.errors.getFieldError('name').codes.contains('org.grails.orm.hibernate.SavePersistentMethodTeam.name.nullable.error.org.grails.orm.hibernate.SavePersistentMethodTeam.name')
    }
    ...
    void testFailOnErrorConfigWithPackagesAndAutoFlush() {
        ...
        team = teamClass.get(1)
        team.name = ''
        // should not throw exception for the org.grails.orm.hibernate package
        session.flush()

        interceptor.failOnErrorPackages = ['org.grails.orm.hibernate']
        interceptor.eventListeners.clear()

        session.clear()
        team = teamClass.get(1)
        team.name = ''
        // should throw exception for the org.grails.orm.hibernate package
        shouldFail(ValidationException) {
            session.flush()
        }
    }
    ...
    void testFailOnErrorConfigIncludesMatchingPackageWithValidationErrors() {
        ga.config.grails.gorm.failOnError = ['com.foo', 'org.grails.orm.hibernate', 'com.bar']
        ga.configChanged()
        def teamClass = ga.getDomainClass(SavePersistentMethodTeam.name)
        def team = teamClass.newInstance()
        team.properties = [homePage: 'invalidurl']
    ...
    void testFailOnErrorConfigFalseArgumentTrueWithValidationErrors() {
        ...
        assert msg.contains('Validation Error(s) occurred during save():')
        assert msg.contains("- Field error in object 'org.grails.orm.hibernate.SavePersistentMethodTeam' on field 'homePage': rejected value [invalidurl]; codes [org.grails.orm.hibernate.SavePersistentMethodTeam.homePage.typeMismatch.error,org.grails.orm.hibernate.SavePersistentMethodTeam.homePage.typeMismatch,savePersistentMethodTeam.homePage.typeMismatch.error,savePersistentMethodTeam.homePage.typeMismatch,typeMismatch.org.grails.orm.hibernate.SavePersistentMethodTeam.homePage,typeMismatch.homePage,typeMismatch.java.net.URL,typeMismatch]; arguments [homePage]; default message [no protocol: invalidurl]")
        assert msg.contains("- Field error in object 'org.grails.orm.hibernate.SavePersistentMethodTeam' on field 'name': rejected value [null]; codes [org.grails.orm.hibernate.SavePersistentMethodTeam.name.nullable.error.org.grails.orm.hibernate.SavePersistentMethodTeam.name,org.grails.orm.hibernate.SavePersistentMethodTeam.name.nullable.error.name,org.grails.orm.hibernate.SavePersistentMethodTeam.name.nullable.error.java.lang.String,org.grails.orm.hibernate.SavePersistentMethodTeam.name.nullable.error,savePersistentMethodTeam.name.nullable.error.org.grails.orm.hibernate.SavePersistentMethodTeam.name,savePersistentMethodTeam.name.nullable.error.name,savePersistentMethodTeam.name.nullable.error.java.lang.String,savePersistentMethodTeam.name.nullable.error,org.grails.orm.hibernate.SavePersistentMethodTeam.name.nullable.org.grails.orm.hibernate.SavePersistentMethodTeam.name,org.grails.orm.hibernate.SavePersistentMethodTeam.name.nullable.name,org.grails.orm.hibernate.SavePersistentMethodTeam.name.nullable.java.lang.String,org.grails.orm.hibernate.SavePersistentMethodTeam.name.nullable,savePersistentMethodTeam.name.nullable.org.grails.orm.hibernate.SavePersistentMethodTeam.name,savePersistentMethodTeam.name.nullable.name,savePersistentMethodTeam.name.nullable.java.lang.String,savePersistentMethodTeam.name.nullable,nullable.org.grails.orm.hibernate.SavePersistentMethodTeam.name,nullable.name,nullable.java.lang.String,nullable]; arguments [name,class org.grails.orm.hibernate.SavePersistentMethodTeam]; default message [Property [{0}] of class [{1}] cannot be null]")
    }
